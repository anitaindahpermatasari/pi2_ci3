...
class pelanggan extends CI_Controller
{
	...
	public function print()
	{
		...
		$data['allpelanggan'] = $this->PelangganModel->get_all_data_pelanggan();
		$data['title'] = "Print Pelanggan";

		$this->load->view('pelanggan/print', $data);
	}
...
<div class="alert alert-success d-flex align-items-center" role="alert">
  ...
  <div>
    <strong>Selamat</strong> Pelanggan Telah Berhasil Di Tambahkan.
  </div>
</div>');
...
<div class="alert alert-success d-flex align-items-center" role="alert">
  <svg class="bi flex-shrink-0 me-2" width="15" height="15" role="img" aria-label="Success:"><use xlink:href="#check-circle-fill"/></svg>
  <div>
    <strong>Selamat</strong> Pelanggan Telah Berhasil Di Edit.
  </div>
</div>');
...
<div class="alert alert-success d-flex align-items-center" role="alert">
  <svg class="bi flex-shrink-0 me-2" width="15" height="15" role="img" aria-label="Success:"><use xlink:href="#check-circle-fill"/></svg>
  <div>
    <strong>Selamat</strong> Pelanggan Telah Berhasil Di Hapus.
  </div>
</div>');
